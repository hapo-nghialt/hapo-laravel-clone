        ...
        <div class="col-8">
            ...
            <div class="content-course-detail pt-3">
                ...
                <div class="tab-content">
                    <div class="container tab-pane fade show active" id="lessons" role="tabpanel" aria-labelledby="lessons-tab">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="lesson-list d-flex justify-content-between align-items-center pr-3">
                                {{ ++$key }} . {{ $item->name }}
                                <a href=""><button class="btn btn-learn px-4">Learn</button></a>
                            </div>
                            @endforeach
                            <hr>
                    ...
                    <div class="container tab-pane fade" id="teachers" role="tabpanel" aria-labelledby="teachers-tab">
                        ...
                        <div class="teacher-desc mt-3 mb-5">
