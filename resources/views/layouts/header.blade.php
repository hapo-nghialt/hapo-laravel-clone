<nav class="navbar navbar-expand-sm no-gutters d-flex justify-content-md-center py-xl-3 py-0">
    <div class="row no-gutters container-fluid d-flex flex-md-wrap">
        <div class="col-xl-4 col-md-12 col-12 d-flex">
            <button aria-controls="collapsibleNavbar" aria-expanded="false" aria-label="Toggle navigation" class="btn-header navbar-toggler" data-target="#collapsibleNavbar" data-toggle="collapse" type="button">
            <span class="fa fa-bars btn-icon"></span>
            </button>
            <div class="img-header d-flex ml-xl-5 mx-auto">
                <img class="img-fluid" alt="" src="images/HapoLearnLogo.png">
            </div>
        </div>
